...
import 'package:project_rumah_sakit/screen_page/page_rumah_sakit.dart';
...
class _PageKabupatenState extends State<PageKabupaten> {
  ...
  Future<void> getKabupaten() async {
    ...
    try {
      final response = await http.get(Uri.parse("http://192.168.43.45/rumahsakit/kabupaten.php"));
