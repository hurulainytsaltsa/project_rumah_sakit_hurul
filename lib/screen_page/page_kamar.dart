...
class _PageKamarState extends State<PageKamar> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      final responseRumah = await http.get(Uri.parse('http://192.168.43.45/rumahsakit/rumahsakit.php?id_rumah=${widget.idRs}'));
      ...
      // Fetch Kamar data
      final responseKamar = await http.get(Uri.parse('http://192.168.43.45/rumahsakit/kamar.php?id_rumah=${widget.idRs}'));
