...
import 'package:project_rumah_sakit/screen_page/page_kamar.dart';
import '../model/model_rumah_sakit.dart';
...
class _PageRumahSakitState extends State<PageRumahSakit> {
  ...
  Future<void> fetchRumahSakitData() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://192.168.43.45/rumahsakit/rumahsakit.php?id_kabupaten=${widget.idKabupaten}'));
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Card(
                    ...
                    elevation: 5,
                    child: ListTile(
                      leading: Image.network('http://192.168.43.45/rumahsakit/gambar/${rumahSakit.gambar}', width: 100, height: 100,),
                      title: Text(
